        ...
        $("div#mws-navigation ul li a, div#mws-navigation ul li span")
			.on('click', function (event) {
			    ...
			    if ($(this).next('ul').hasClass('closed')) {
			        $("div#mws-navigation ul li ul").hide();
			        $("div#mws-navigation ul li ul").addClass("closed");
			        $("div#mws-navigation ul li a, div#mws-navigation ul li span").removeClass();
			    }
...
function hideMenu() {
    $(document).on('click', 'body', function () {
        $("#mws-navigation li ul").each(function () {
