...
namespace DAO
{
    ...
    public partial class dbHRSystemEntities : DbContext
    {
        public dbHRSystemEntities()
            : base("name=dbHRSystemEntities")
        {
        }
        ...
        public DbSet<CountryOffice> CountryOffices { get; set; }
        ...
        public DbSet<EmployeeHoilday> EmployeeHoildays { get; set; }
        ...
        public DbSet<ServiceBonu> ServiceBonus { get; set; }
        public DbSet<Employee> Employees { get; set; }
        public DbSet<WeekendWorkingDay> WeekendWorkingDays { get; set; }
        ...
        public virtual ObjectResult<DeleteWeekendAndHolidays_Result> DeleteWeekendAndHolidays(Nullable<System.Guid> timeSheetMasterID, Nullable<System.Guid> employeeID)
        {
            var timeSheetMasterIDParameter = timeSheetMasterID.HasValue ?
                new ObjectParameter("TimeSheetMasterID", timeSheetMasterID) :
                new ObjectParameter("TimeSheetMasterID", typeof(System.Guid));
    
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("employeeID", employeeID) :
                new ObjectParameter("employeeID", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DeleteWeekendAndHolidays_Result>("DeleteWeekendAndHolidays", timeSheetMasterIDParameter, employeeIDParameter);
        }
    
        public virtual ObjectResult<SP_Report_Result> SP_Report(Nullable<int> action)
        {
            var actionParameter = action.HasValue ?
                new ObjectParameter("action", action) :
                new ObjectParameter("action", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Report_Result>("SP_Report", actionParameter);
        }
    }
}
